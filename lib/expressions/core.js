 ...
 * aliases
 */
coreExpressions['open {{STR}}']
  = coreExpressions['open browser {{STR}}'];
coreExpressions['enter {{STR1}} into {{STR2}}']
  = coreExpressions['enter text {{STR1}} into {{STR2}}'];
coreExpressions['verify text {{STR}}']
  = coreExpressions['see {{STR}}'];

module.exports = coreExpressions;
